...
void whip_session_transport::set_ice_context(std::string stream_id, std::string session_id, ice_credentials local_ice, std::string remote_ice_ufrag)
{
...
void whip_session_transport::set_dtls_peer_identity(dtls_peer_identity identity)
{
...
session_udp_dispatch_result whip_session_transport::handle_udp_packet(const session_udp_packet& packet)
{
